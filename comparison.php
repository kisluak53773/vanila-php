...
$testEmail = "soememail@gmail.com";

var_dump(isEmail($testEmail));

function findUpperLetterString(string $str): array
{
...
$testString = "soem ASs Wwwe ASsa";

var_dump(findUpperLetterString($testString));